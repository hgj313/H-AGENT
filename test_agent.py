...
if __name__ == "__main__":
    ...
    # 批量 PDF 文件列表
    files = [
        # 新增：粤灿主保单（批单 X44061701260000083506 的主文件）
        "D:/工作资料/2026/6月/AI项目/AI保险/保单/电子保单+广州市粤灿建设工程有限公司+X44061701260000083506.pdf",
        # 新增：重庆森得尔保单
        "D:/工作资料/2026/6月/AI项目/AI保险/保单/保单_重庆森得尔劳务有限公司_8116013100260068880000(2).pdf",
        # 已有：兴文县欣雅保单
