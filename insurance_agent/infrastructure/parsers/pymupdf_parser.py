...
class PyMuPDFParser:
    ...
    _COMPANY_PATTERNS = {
        ...
        "中国平安": ["平安保险", "平安养老", "中国平安", "Ping An", "平安养老保险", "pingan"],
        # 2026-09-24 新增：平安养老单独识别（保险起期+批改人员清单格式）
        # PEAC 前缀号段 + "平安养老"关键词（单独列避免与"中国平安"通用识别冲突）
        "平安养老保险": ["平安养老"],
        "中国人民保险": ["人民保险", "PICC"],
        "泰康保险": ["泰康"],
        "阳光保险": ["阳光"],
        ...
        # 北部湾财产保险 2026-09-22 新增：重庆廊虎商贸"雇主责任保险电子保单"新格式
        # 文本特征："北部湾财产保险股份有限公司" + 官网 www.bgic.com + 客服电话 400-990-9999
        "北部湾财产保险": ["北部湾财产保险", "北部湾", "bgic", "400-990-9999"],
    }
    ...
    _POLICY_NUMBER_TO_COMPANY = {
        ...
        "804147": "北部湾财产保险",      # 北部湾号段（重庆廊虎商贸 8041472013... 证实，2026-09-22 新增）
        "PEAC": "平安养老保险",           # 平安养老号段（天津虹跃云 PEAC20261201... 证实，2026-09-24 新增）
    }
